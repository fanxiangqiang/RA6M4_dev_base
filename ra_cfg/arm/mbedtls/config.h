...
#define RM_PSA_CRYPTO_CFG_RSA3K_ENABLED 0
#define RM_PSA_CRYPTO_CFG_RSA4K_ENABLED 0
 ...
 * This only works if MBEDTLS_PSA_CRYPTO_KEY_ID_ENCODES_OWNER is also enabled.
 */
#if 0
